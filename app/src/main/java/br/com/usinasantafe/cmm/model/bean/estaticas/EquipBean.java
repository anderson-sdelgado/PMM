...
public class EquipBean extends Entidade {
    ...
    public Long getFlagApontPneu() {
        return flagApontPneu;
    }

    public void setFlagApontPneu(Long flagApontPneu) {
        this.flagApontPneu = flagApontPneu;
    }
}
