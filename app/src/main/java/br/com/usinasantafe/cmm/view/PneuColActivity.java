    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonOkPneu.setOnClickListener(v -> {
            ...
            if (!editTextPadrao.getText().toString().equals("")) {
                ...
                String nroPneu = editTextPadrao.getText().toString();
                cmmContext.getPneuCTR().getItemManutPneuBean().setNroPneuColItemManutPneu(nroPneu);
                if (cmmContext.getPneuCTR().verPneuNro(nroPneu)) {
                    LogProcessoDAO.getInstance().insertLogProcesso("if (cmmContext.getPneuCTR().verPneuNro(nroPneu)) {\n" +
                            "                    cmmContext.getPneuCTR().salvarItemManutPneu();\n" +
                    ...
                    if (connectNetwork) {
                        ...
                        LogProcessoDAO.getInstance().insertLogProcesso("cmmContext.getPneuCTR().verPneu(nroPneu, PneuColActivity.this, ListaPosPneuActivity.class, progressBar, getLocalClassName());", getLocalClassName());
                        cmmContext.getPneuCTR().verPneu(nroPneu, PneuColActivity.this, ListaPosPneuActivity.class, progressBar, getLocalClassName());
                        ...
                        AlertDialog.Builder alerta = new AlertDialog.Builder(PneuColActivity.this);
                        alerta.setTitle("ATENÇÃO");
